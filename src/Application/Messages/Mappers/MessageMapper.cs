...
public static class MessageMapper
{
    ...
    {
        Message message = new() { SenderId = userId, ChatId = command.ChatId, Content = command.Content };
        return message;
    }
    public static MessageDto ToMessageDto(this Message message)
    {
        var messageDto = new MessageDto { Content = message.Content, SenderId = message.SenderId, Id = message.Id };
        return messageDto;
    }
